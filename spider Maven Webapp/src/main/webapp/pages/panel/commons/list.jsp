	        ...
	        <table class="table table-border table-hover">
	            <thead class="thead-inverse">
		            <tr>
		                ...
		                <th style="text-align:center">转到</th>
	            ...
	            <tbody>
	            	<c:if test="${resultBundle ne null}">
                        <c:forEach items="${resultBundle}" var="webpage" varStatus="wpIndex">
	            			<tr>
			                    <th scope="row" style="text-align:center">${wpIndex.count}</th>
			                    <td style="text-align:center">${webpage.title}</td>
			                    <td style="text-align:center">${webpage.domain}</td>
			                    <td style="text-align:center"><fmt:formatDate value="${webpage.gathertime}" pattern="yyyy/MM/dd HH:mm:ss"/></td>
