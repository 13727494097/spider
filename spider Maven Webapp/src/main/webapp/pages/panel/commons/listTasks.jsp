...
<div class="container">
    <button onclick="rpcAndShowData2('删除全部已停止爬虫','${pageContext.request.contextPath}/commons/spider/deleteAll','','${pageContext.request.contextPath}/panel/commons/tasks')"
    ...
    <table class="table table-hover">
        ...
        <tr>
            ...
            <th style="text-align:center">抓取状态列表</th>
            <!-- <th style="text-align:center">查看详情</th>
            <th style="text-align:center">编辑模板</th> -->
            <th style="text-align:center">查看数据</th>
        ...
        <c:forEach items="${resultBundle.resultList}" var="task" varStatus="index">
            <tr>
                ...
                <td style="text-align:center">${task.dataType}</td>
                <td style="text-align:center">${task.dataCategory}</td>
                <td style="text-align:center">${task.name}</td>
                <td style="text-align:center">${task.count}</td>
                <td style="text-align:center">${task.state}</td>
              ...
              <%--   <td style="text-align:center">
                ...
                <td style="text-align:center">
                    ...
                    <c:if test="${task.state == 'STOP'}">
                        <button onclick="rpcAndShowData2('删除此任务','${pageContext.request.contextPath}/commons/spider/delete',{uuid:'${task.taskId}'},'${pageContext.request.contextPath}/panel/commons/tasks')"
                    ...
                    <c:if test="${spiderInfoList.get(index.index) == \"null\"}">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <div class="dropdown-divider"></div>
                                <a class="dropdown-item">导出到数据库</a>
                            </div>
                        </div>
                    </c:if>
                    <c:if test="${spiderInfoList.get(index.index) != \"null\"}">
                        <div class="btn-group">
                            ...
                            <div class="dropdown-menu">
                                ...
                                <a class="dropdown-item"
                                   ...
                                   <div class="dropdown-divider"></div>
                                <a class="dropdown-item" 
                                	onclick="rpcAndShowData2('导出到数据库','${pageContext.request.contextPath}/commons/webpage/exportWebpageDATABASEySpiderUUID',{uuid:'${task.taskId}'},'${pageContext.request.contextPath}/panel/commons/tasks')"
                                   >导出到数据库</a>
                            </div>
                        </div>
                    </c:if>
