...
public class CommonsSpiderPanel extends BaseController {
    ...
    public ModelAndView editSpiderInfo(String jsonSpiderInfo) {
        ...
        modelAndView.addObject("dataList", SysUtil.js);
        return modelAndView;
    }
    ...
    @RequestMapping(value = "parameter_config")
    public String parameterConfig(Model model) {
    	JSONArray ja=SysUtil.js;
    	if(null==ja){
    		model.addAttribute("dataList", 1);
    	}else{
    		model.addAttribute("dataList", ja);
    	}
        return "panel/commons/parameter_config";
    }
    ...
    public ModelAndView saveData(@RequestParam(value = "send_data", required = false)String send_data) {
    	JSONArray ja=JSONArray.parseArray(send_data);
    	SysUtil.js=ja;
    	ModelAndView modelAndView = new ModelAndView("panel/commons/parameter_config");
    	return modelAndView;
    }
}
