...
public class CommonWebpageController {
    ...
    /**
     * 根据爬虫id导出 webpage的数据库
     *
     * @param uuid       爬虫id
     * @param includeRaw 是否包含网页快照
     */
    @RequestMapping(value = "exportWebpageDATABASEySpiderUUID", method = RequestMethod.GET, produces = "application/json")
    @ResponseBody
    public ResultBundle<String> exportWebpageDATABASEySpiderUUID(String uuid,String dataType,String dataCategory,
                                              @RequestParam(value = "includeRaw", required = false, defaultValue = "false") Boolean includeRaw) throws IOException {
     	
    	return webpageService.exportWebpageDATABASEySpiderUUID(uuid, includeRaw,dataType,dataCategory);
    }
      
    /**
     * 根据爬虫domain导出 webpage的数据库
     *
     * @param uuid       爬虫id
     * @param includeRaw 是否包含网页快照
     */
    @RequestMapping(value = "exportWebpageDATABASEyDomain", method = RequestMethod.GET, produces = "application/json")
    @ResponseBody
    public ResultBundle<String> exportWebpageDATABASEyDomain(String domain,@RequestParam(value = "includeRaw", required = false, defaultValue = "false") Boolean includeRaw) throws IOException {
       return  webpageService.exportWebpageDATABASEyDomain(domain, includeRaw);
    }
}
