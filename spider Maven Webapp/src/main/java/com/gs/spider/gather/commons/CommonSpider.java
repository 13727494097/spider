...
//        }
            ...
            //用户类型和用户类别
            page.putField("dataType",info.getDataType());
            page.putField("dataCategory",info.getDataCategory());
    ...
    public String start(SpiderInfo info) throws JMException {
        ...
        Task task = taskManager.initTask(uuid, info.getDomain(),info.getDataType(),info.getDataCategory(), info.getCallbackURL(), "spiderInfoId=" + info.getId() + "&spiderUUID=" + uuid);
